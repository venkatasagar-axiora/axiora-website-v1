...
import pwe from "../../components/assests/upadiai.jpg";

export default function UpadiAI() {
                ...
                <div className="max-w-6xl w-full grid md:grid-cols-2 gap-10 items-center">
                    ...
                    >
                        ...
                        <p className="text-white/60 text-lg leading-relaxed mb-6">
                            <span className="text-white font-medium">Upadi AI</span>  is an AI-powered earning platform that connects people to daily work, freelancing, selling, and renting opportunities through one unified system—creating continuous income access for everyone.
                        </p>

                        <p className="text-white/50 text-base leading-relaxed mb-8">
                            It addresses unemployment by matching skills, availability, and location with verified earning opportunities. The platform enables individuals to earn through micro jobs, freelance services, product selling, and asset renting—while businesses gain instant access to trusted workers.
                        </p>
...
const features = [
    {
        title: "AI Work Recommendation Engine",
        desc: "Suggests earning opportunities based on skills, behavior, and location."
    },
    {
        title: "Micro Jobs & Daily Work Marketplace",
        desc: "Access short-term, part-time, and flexible work near home."
    },
    {
        title: "Freelancing & Service Platform",
        desc: "Verified professionals offer services with secure payments."
    },
    {
        title: "Hyperlocal Buy & Sell Marketplace",
        desc: "Sell products quickly with AI pricing and buyer matching."
    }
];
