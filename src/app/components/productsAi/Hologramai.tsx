...
import pwe from "../assests/hologramai.png";

export default function HologramAI() {
                ...
                <div className="max-w-6xl w-full grid md:grid-cols-2 gap-10 items-center">
                    ...
                    >
                        ...
                        <p className="text-white/60 text-lg leading-relaxed mb-6">
                            <span className="text-white font-medium">Hologram AI</span> is a real-time telepresence system that projects a life-size 3D holographic presence of a remote person into your space—making conversations feel natural, immersive, and face-to-face.
                        </p>

                        <p className="text-white/50 text-base leading-relaxed mb-8">
                            It uses volumetric capture, AI processing, and low-latency streaming to render a realistic 3D projection of participants in real time. With natural eye contact, spatial audio, and body language fidelity, communication becomes clearer, more confident, and more engaging.                        </p>
...
const features = [
    {
        title: "Life-Size 3D Projection",
        desc: "Life-Size 3D ProjectionProjects participants in realistic scale with natural eye-line interaction."
    },
    {
        title: "Spatial Audio Communication",
        desc: "Directional audio creates immersive, in-room conversation experience."
    },
    {
        title: "AI-Powered Visual Fidelity",
        desc: "Enhances gestures, expressions, relighting, and background separation."
    },
    {
        title: "Low-Latency Real-Time Streaming",
        desc: "Neural compression enables smooth, natural interaction."
    }
];
