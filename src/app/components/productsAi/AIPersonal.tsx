...
import pwe from "../assests/aipersonal.png";

export default function AIPersonal() {
                ...
                <div className="max-w-6xl w-full grid md:grid-cols-2 gap-10 items-center">
                    ...
                    >
                        ...
                        <img
                            src={pwe}
                            alt="Udyogaa AI"
                            className="relative z-10 rounded-xl w-full max-w-md h-75 object-cover mx-auto"
                            height={`40px`}
                        />
                    </motion.div>
                    ...
                    >
                        ...
                        <h1 className="text-4xl md:text-5xl font-semibold mb-6 tracking-tight">
                            Eco-Friendly AI Personal Assistant
                        </h1>

                        {/* Description */}
                        <p className="text-white/60 text-lg leading-relaxed mb-6">
                            <span className="text-white font-medium">AIA</span> is an intelligent, human-centered AI companion designed to support daily life, emotional well-being, decision-making, and productivity through continuous guidance, reminders, and personalized assistance.
                        </p>

                        <p className="text-white/50 text-base leading-relaxed mb-8">
                            AIA acts as a personal assistant, mentor, and supportive companion that understands context, behavior, and priorities. It simplifies life by managing reminders, organizing responsibilities, providing guidance, and offering calm, supportive interaction whenever needed.
                        </p>
...
const features = [
    {
        title: "Intelligent Life Management",
        desc: "Tracks bills, renewals, tasks, and commitments with caring, timely reminders."
    },
    {
        title: "Emotional Awareness & Support",
        desc: "Responds to mood, stress, and behavior with supportive communication."
    },
    {
        title: "Smart Decision Guidance",
        desc: "Provides clarity for career, financial, and life decisions."
    },
    {
        title: "Health & Lifestyle Companion",
        desc: "Encourages balance through reminders for rest, movement, and wellness."
    }
];
