...
import pwe from "../../components/assests/payment-collection-application.jpg";
export default function PayWithEasy() {
                ...
                <div className="max-w-6xl w-full grid md:grid-cols-2 gap-10 items-center">
                    ...
                    >
                        ...
                        <p className="text-white/60 text-lg leading-relaxed mb-6">
                            <span className="text-white font-medium">PayWithEasy</span> is an intelligent financial operations platform that manages collections, commitments, installments, invoicing, payouts, and profit visibility in one unified system.
                        </p>

                        <p className="text-white/50 text-base leading-relaxed mb-8">
                            It goes beyond payment gateways to help businesses control cash flow, reduce follow-ups, and understand real profitability. PayWithEase transforms business payments into a structured, automated, and intelligent workflow.                        </p>
...
const features = [
    {
        title: "Commitment-Based Payment Tracking",
        desc: "Capture promises, due dates, and partial payments intelligently."
    },
    {
        title: "Installment Management System",
        desc: "Automatically track balances, schedules, and pending amounts."
    },
    {
        title: "Automated Follow-Up Engine",
        desc: "Send reminders through intelligent notifications and messaging."
    },
    {
        title: "Vendor & Payroll Payout Management",
        desc: "Handle expenses, salaries, and vendor payments from one system."
    }
];
