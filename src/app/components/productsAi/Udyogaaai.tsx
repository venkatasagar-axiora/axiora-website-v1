...
import pwe from "../../components/assests/epub.jpg";
export default function UdyogaaAI() {
                ...
                <div className="max-w-6xl w-full grid md:grid-cols-2 gap-10 items-center">
                    ...
                    >
                        ...
                        <p className="text-white/60 text-lg leading-relaxed mb-6">
                            <span className="text-white font-medium">Udyogaa AI</span> is India’s first AI-driven voice-based hiring intelligence system that automates recruitment, verifies candidates, predicts backouts, and enables productivity-based hiring without vendors or job portals.
                        </p>

                        <p className="text-white/50 text-base leading-relaxed mb-8">
                            It replaces traditional hiring workflows with an intelligent automation platform that evaluates candidates through AI interviews, identity verification, skill validation, and behavioral prediction.
                        </p>
...
const features = [
    {
        title: "AI Voice-Based Interviews",
        desc: "Automatically conducts technical and behavioral interviews with verified video proof."
    },
    {
        title: "Verified Candidate Intelligence",
        desc: "Identity validation, background checks, and skill authenticity verification."
    },
    {
        title: "Backout Risk Predictor",
        desc: "AI predicts offer shopping, joining probability, and negotiation risks."
    },
    {
        title: "Unlimited Hiring Subscription Model",
        desc: "Hire without vendor commissions or per-closure fees."
    }
];
