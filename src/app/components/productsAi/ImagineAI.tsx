...
import pwe from "../assests/human.png";
                ...
                <div className="max-w-6xl w-full grid md:grid-cols-2 gap-10 items-center">
                    ...
                    >
                        ...
                        <p className="text-white/60 text-lg leading-relaxed mb-6">
                            <span className="text-white font-medium">Imagine AI</span> is an intelligent communication platform that converts human intent into visual, audio, and structured digital outputs. It helps individuals and teams express ideas clearly, collaborate faster, and transform imagination into executable content.
                        </p>

                        <p className="text-white/50 text-base leading-relaxed mb-8">
                            Imagine AI converts intent into visuals, narration, and structured briefs—making complex ideas clear, shareable, and easy to execute.
                        </p>
...
const features = [
    {
        title: "Thought-to-Visual Generation",
        desc: "Transform ideas into images, storyboards, and visual drafts."
    },
    {
        title: "Personalized Intelligence Engine",
        desc: "Learns user patterns to improve output accuracy over time."
    },
    {
        title: "Collaboration-Ready Outputs",
        desc: "Share previews, collect feedback, and align stakeholders quickly."
    },
    {
        title: "Privacy-First Architecture",
        desc: "Secure data handling with user-controlled information access."
    }
];
